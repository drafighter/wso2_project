...
public class ChUserVo {
	...
	@ApiModelProperty(required = true,		value = "통합고객번호",		 position = 2)
	private String incsNo;
	
	@ApiModelProperty(required = true,		value = "경로비밀번호", 	 position = 3)
	private String password;
	
	@ApiModelProperty(required = true,		value = "계정전환여부", 	 position = 4)
