 ...
 *    |_ Wso2SoapApiCreateAssociatedVo.java
 * </pre>
 *
 * @desc    :
 * @date    : 2020. 8. 13.
...
public class Wso2SoapApiCreateAssociatedVo {

	@ApiModelProperty(value = "Amore Pacific SNS IDP Name", dataType = "java.lang.String", position = 1)
	private String snsIdpName;
	
	@ApiModelProperty(value = "Amore Pacific SNS User ID", dataType = "java.lang.String", position = 2)
