...
public class PasswdChangeResponse extends CommonVo{
	private static final long serialVersionUID = 1236836274853571095L;
	private String result; //결과코드 SUCCESS : 성공 ERROR : 오류
	...
	public void SetResponseInfo(JoinOnResultCode resultCode) {
		...
		this.setRsltMsg(resultCode.message());
		
		if("000".equals(resultCode.getCode())){
