...
<!DOCTYPE html><!-- conversion terms a202 01 ch conversion new password -->
<html lang="ko">
<head>
  ...
  $(document).ready(function() {
	  ...
	  $("input[type=checkbox]:not(#all_chk)").change(function() {
		...
		$('#do-convs').on('click', function() { //A0205 통합회원전환완료
			...
			$('#trnsForm')
		  	.attr('action', OMNIEnv.ctx + '/convs/terms-finish-202-01-ch') //convs/finish
		  	.submit();
...
<body>
  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      ...
      <div class="sec_join">
        <div class="user_info">
          <h3><em class="tit tit_w20">아이디</em> <c:out escapeXml="false" value="${loginid}" /></h3>
          <input type='hidden' name='loginid' id='loginid' value='<c:out value="${loginid}"/>'/>
          <dl class="dt_w20">
            <dt>이름</dt>
            <dd><c:out escapeXml="false" value="${name}" /></dd>
          </dl>
        </div>
        <c:if test="${certType eq 'ipin'}">
        ...
        <form id='trnsForm' method='post' action=''>
          ...
          <div class="all_agree_box is_open">
            ...
            <div class="agree_list">
              ...
              <ul>
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms1" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (필수) '뷰티포인트 서비스 이용 약관' 체크 박스" ap-click-data="(필수) '뷰티포인트 서비스 이용 약관'"><span class="checkbox_label">[필수] 뷰티포인트 서비스 이용 약관</span></label>
                  </span>
                  <a href="javascript:;" ap-click-name="통합회원 전환 01 (자체) - (필수) '뷰티포인트 서비스 이용 약관' 상세 보기 버튼" ap-click-data="(필수) '뷰티포인트 서비스 이용 약관' 상세 보기" class="btn_link_bp" data-type='S'><span class="blind">자세히보기</span></a>
                </li>
                ...
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms2" ap-click-area="통합회원 전환 01 (자체)" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="약관동의 - (필수) '개인정보 이용 및 수집에 대한 동의' 체크 박스" ap-click-data="(필수) '개인정보 이용 및 수집에 대한 동의'"><span class="checkbox_label">[필수] 개인정보 이용 및 수집에 대한 동의</span></label>
                  </span>
                  <a href="javascript:;" ap-click-name="통합회원 전환 01 (자체) - (필수) '개인정보 이용 및 수집에 대한 동의' 상세 보기 버튼" ap-click-data="(필수) '개인정보 이용 및 수집에 대한 동의' 상세 보기" class="btn_link_bp" data-type='C'><span class="blind">자세히보기</span></a>
                </li>
              ...
              <c:forEach items="${corptermslist}" var="corpterm" varStatus="corpstatus">
                ...
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms4" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (선택) '개인정보 제 3자 제공 동의' 체크 박스" ap-click-data="(선택) '개인정보 제 3자 제공 동의'"><span class="checkbox_label">[선택] 개인정보 제 3자 제공 동의</span><em class="sm">*외부 컨텐츠 마케팅 활용</em></label>
                  </span>
                  <a href="javascript:;" ap-click-name="통합회원 전환 01 (자체) - (필수) '개인정보 제 3자 제공 동의' 상세 보기 버튼" ap-click-data="(필수) '개인정보 제 3자 제공 동의' 상세 보기" class="btn_link_bp" data-type='A'><span class="blind">자세히보기</span></a>
                </li>
                ...
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms5" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (선택) '국외 이전 동의' 체크 박스" ap-click-data="(선택) '국외 이전 동의'"><span class="checkbox_label">[선택] 국외 이전 동의</span></label>
                  </span>
                  <a href="javascript:;" ap-click-name="통합회원 전환 01 (자체) - (선택) '국외 이전 동의' 상세 보기 버튼" ap-click-data="(선택) '국외 이전 동의' 상세 보기" class="btn_link_bp" data-type='T'><span class="blind">자세히보기</span></a>
                </li>
              ...
              <ul>
                ...
                <li>
	                ...
	                <li>
	                  <common:info-notice gaArea="통합회원 전환 01 (자체)" channelName="뷰티포인트"/>
	                </li>                
	              </ul>
              </li>
              </ul>
        	...
        	<c:forEach items="${chterms}" var="chterm" varStatus="status">
                <li>
                  <span class="checkboxA">
                    <input type="checkbox" id="i_agree_${chterm.chCd}${status.count}" <c:if test="${chterm.tncAgrMandYn eq 'Y'}">class="required"</c:if> name="terms_check" data-cd="${chterm.tcatCd}" data-no="${chterm.tncvNo}" title="(${chterm.tncAgrMandYnTxt}) '${chterm.tncTtl}'"/>
                    <label for="i_agree_${chterm.chCd}${status.count}" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (${chterm.tncAgrMandYnTxt}) '${chterm.tncTtl}' 체크 박스" ap-click-data="(${chterm.tncAgrMandYnTxt}) '${chterm.tncTtl}'"><span class="checkbox_label">[${chterm.tncAgrMandYnTxt}] ${chterm.tncTtl}</span></label>
                  </span>
                  <a href="javascript:;" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (${chterm.tncAgrMandYnTxt}) '${chterm.tncTtl}' 상세보기 버튼" ap-click-data="(${chterm.tncAgrMandYnTxt}) '${chterm.tncTtl}' 상세보기" class="btn_link" data-lnk="<c:out value="${chterm.tncTxtUrl}"/>" data-chcd="${chterm.chCd}" data-lnkcd="${chterm.tcatCd}" data-lnkno="${chterm.tncvNo}"><span class="blind">자세히보기</span></a>
                </li>
