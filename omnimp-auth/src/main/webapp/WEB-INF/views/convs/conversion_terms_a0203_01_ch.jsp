...
<!DOCTYPE html><!-- conversion a203 01 ch -->
<html lang="ko">
<head>
			...
			$.ajax({
				...
				success: function(data) {
					if (data.resultCode === '1') {
						...
						$('#trnsForm')
					  	.attr('action', OMNIEnv.ctx + '/convs/terms-finish-203-01-ch') // /convs/finish
					  	.submit();
    ...
    <section class="container">
      ...
      <div class="sec_join">
        <div class="user_info">
          ...
          <input type='hidden' id='chloginid' value='<c:out value="${loginid}" />'/>
          <dl class="dt_w20">
            <dt>이름</dt>
            ...
            <div class="agree_list">
              ...
              <ul>
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms1" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (필수) '뷰티포인트 서비스 이용 약관' 체크 박스" ap-click-data="(필수) '뷰티포인트 서비스 이용 약관'"><span class="checkbox_label">[필수] 뷰티포인트 서비스 이용 약관 (<c:out value="${channelName}" />)</span></label>
                  </span>
                  <a href="javascript:;" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (필수) '뷰티포인트 서비스 이용 약관' 상세보기 버튼" ap-click-data="(필수) '뷰티포인트 서비스 이용 약관' 상세보기" class="btn_link_bp" data-type='S'><span class="blind">자세히보기</span></a>
                </li>
                ...
                <li>
                  <span class="checkboxA">
                    ...
                    <label for="i_agree_bpterms2" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (필수) '개인정보 이용 및 수집에 대한 동의' 체크 박스" ap-click-data="(필수) '개인정보 이용 및 수집에 대한 동의'"><span class="checkbox_label">[필수] 개인정보 이용 및 수집에 대한 동의</span></label>
                  </span>
                  <a href="javascript:;" ap-click-name="통합회원 전환 01 (자체) - (필수) '개인정보 이용 및 수집에 대한 동의' 상세보기 버튼" ap-click-data="(필수) '개인정보 이용 및 수집에 대한 동의' 상세보기" class="btn_link_bp" data-type='C'><span class="blind">자세히보기</span></a>
                </li>
              ...
              <c:forEach items="${corptermslist}" var="corpterm" varStatus="corpstatus">
                ...
                <li>
                  ...
                  <a href="javascript:;" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (선택) '개인정보 제 3자 제공 동의' 상세보기 버튼" ap-click-data="(선택) '개인정보 제 3자 제공 동의' 상세보기" class="btn_link_bp" data-type='A'><span class="blind">자세히보기</span></a>
                </li>
                ...
                <li>
                  ...
                  <a href="javascript:;" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (선택) '국외 이전 동의' 상세보기 버튼" ap-click-data="(선택) '국외 이전 동의' 상세보기" class="btn_link_bp" data-type='T'><span class="blind">자세히보기</span></a>
                </li>
        	...
        	<c:forEach items="${chterms}" var="chterm" varStatus="status">
                <li>
                 <span class="checkboxA">
                    ...
                    <label for="i_agree_<c:out value="${chterm.chCd}"/><c:out value="${status.count}"/>" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (<c:out value="${chterm.tncAgrMandYnTxt}"/>) '<c:out value="${chterm.tncTtl}"/>' 체크 박스" ap-click-data="(<c:out value="${chterm.tncAgrMandYnTxt}"/>) '<c:out value="${chterm.tncTtl}"/>'"><span class="checkbox_label">[${chterm.tncAgrMandYnTxt}] <c:out value="${chterm.tncTtl}"/></span></label>
                  </span>
                  <a href="javascript:;" class="btn_link" ap-click-area="통합회원 전환 01 (자체)" ap-click-name="통합회원 전환 01 (자체) - (<c:out value="${chterm.tncAgrMandYnTxt}"/>) '<c:out value="${chterm.tncTtl}"/>' 상세 보기 버튼" ap-click-data="(<c:out value="${chterm.tncAgrMandYnTxt}"/>) '<c:out value="${chterm.tncTtl}"/>' 상세 보기" data-lnk="<c:out escapeXml="false" value="${chterm.tncTxtUrl}"/>" data-chcd="<c:out escapeXml="false" value="${chterm.chCd}"/>" data-lnkcd="<c:out escapeXml="false" value="${chterm.tcatCd}"/>" data-lnkno="<c:out escapeXml="false" value="${chterm.tncvNo}"/>"><span class="blind">자세히보기</span></a>
                </li>
