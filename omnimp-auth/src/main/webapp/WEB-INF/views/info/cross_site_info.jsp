...
<body>
  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      ...
      <div class="cs_cont">
        <p class="txt" style="text-align: center;">뷰티포인트 통합회원 서비스 이용을 위하여<br> 웹 사이트 추적 방지를 해제 해주시기 바랍니다.</p>
        <p class="txt"></p>
        <p class="txt">
        	1. 아이폰 설정 앱 실행<br>
        	2. 접속 중인 웹 브라우저 선택 (Safari, Chrome 등)<br>
        	3. ‘크로스 웹 사이트 추적 방지’ → 해제로 변경</p>
