<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
          ...
          <div class="agree-txt" tabindex="0">
            ...
            <table>
              <caption>개인정보 제공동의 : 개인정보를 제공받는자, 제공목적, 제공하는 개인정보 항목, 보유 및 이용기간</caption>
              <colgroup>
                <col width="20%">
                <col width="*">
                <col width="20%">
              ...
              <tbody>
                <tr>
                  <td class="agree_txt_strong">Facebook</td>
                  <td class="agree_txt_strong">페이스북 맞춤 타겟(Custom Audiences) 마케팅</td>
                  <td>이메일, 휴대폰 번호</td>
                  <td class="agree_txt_strong">페이스북 캠페인 대상선정 이후 14일</td>
                </tr>
              </tbody>
            </table>
            ...
            <p class="agree_txt_strong">5. 회사는 개인정보를 국외의 제3자에게 제공할 때에는 이용자에게 내용을 알리고 동의를 받습니다.</p>
          </div>
