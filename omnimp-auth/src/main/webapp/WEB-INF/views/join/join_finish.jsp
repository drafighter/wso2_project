...
<body>
  ...
  <div id="wrap" class="wrap">
  	<common:header title="회원가입 완료" type="goaction"/>
    <!-- container -->
    <section class="container">
      ...
      <div class="btn_submit">
      	<c:if test="${!isConfirmBtn}">
      		<button type="button" class="btnA btn_blue" id='redirect-on' ap-click-area="회원 가입 완료" ap-click-name="회원 가입 완료 - 메인으로 이동 버튼" ap-click-data="메인으로 이동">메인으로 이동</button>
      	</c:if>
      	<c:if test="${isConfirmBtn}">
