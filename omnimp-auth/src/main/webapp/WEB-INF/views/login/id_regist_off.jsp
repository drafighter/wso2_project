...
<!DOCTYPE html><!-- ME-FO-A0216 id regist off O X O -->
<html lang="ko">
<head>
  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      <div class="page_top_area">
        ...
        <p>회원님은 <c:out value="${channelName}"/> 가입 회원 입니다.<br class="w320" />뷰티포인트 통합 아이디를 등록하면 아모레퍼시픽 브랜드의 온라인 서비스를 이용하실 수 있습니다.</p>
      </div>
      <div class="">
