...
<!DOCTYPE html><!-- ME-FO-A0217 plogin id regist -->
<html lang="ko">
<head>
  ...
  $(document).ready(function() {
		...
		$('#do-regist-login').on('click', function() {
			...
			if (validId.code > 0 && validPw.code > 0) {
				...
				$('#joinform')
				.attr('action', OMNIEnv.ctx + '/join/plogin-regist')
				.submit();
  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      <div class="page_top_area">
        ...
        <p>통합 아이디를 등록하면 아모레퍼시픽 뷰티포인트<br class="w320" />와 <c:out value="${channelName}" /> 회원으로 가입되며, 온라인 서비스를 이용할 수 있습니다.</p>
      </div>
      <div class="">
