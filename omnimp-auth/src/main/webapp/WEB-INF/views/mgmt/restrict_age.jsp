  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      ...
      <div class="btn_submit mt40">
        <button type="button" class="btnA btn_blue" id='go-home' ap-click-area="가입 제한 안내" ap-click-name="가입 제한 안내 - 확인 버튼 (가입 제한 만 14세 미만)" ap-click-data="확인 버튼 (가입 제한 만 14세 미만)">확인</button>
      </div>
