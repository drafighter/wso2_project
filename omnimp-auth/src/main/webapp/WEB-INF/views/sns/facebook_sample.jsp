...
<head>
  ...
  <script>
	  ...
	  $(document).ready(function() {
		  $('#facebook_test').on('click', function() {
				location.href = OMNIEnv.ctx + "/sns/auth/fbsu";
			});
...
<script async defer crossorigin='anonymous' src='https://connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v12.0&appId=<c:out escapeXml="false" value="${FBRestApiKey}" />&autoLogAppEvents=1' nonce='xbW0ijkt'></script>
  ...
  <div id="wrap" class="wrap">
    ...
    <div class="login_guide_text">
	    <span>아모레퍼시픽 FACEBOOK<br>아이디로 로그인해주세요.</span>
    </div>
      <div class="sec_login">
        <login:keyboard/>
		<div class="btn_submit">
	      	<div style="margin: 0 auto;">
	      		<button class="facebook_test" id="facebook_test"></button>
	      	</div>
      	</div>
      </div>
    </section>
