...
<!DOCTYPE html><!-- a0109 terms apply off -->
<html lang="ko">
<head>
  ...
  <script type="text/javascript">
	$(document).ready(function() {
		...
		$('#term-agree-ok').on('click', function() {
			...
			$('#termsForm')
			.attr('action', OMNIEnv.ctx + '/join/terms/offline')
			.submit();
		});
  ...
  <div id="wrap" class="wrap">
    ...
    <section class="container">
      <div class="page_top_area">
        ...
        <p><c:out value="${channelName}" /> 약관에 동의하시면 통합 아이디로 <c:out value="${channelName}" /> 회원에 가입 하실 수 있습니다.</p>
      </div>
      <div class="sec_join">
        <div class="user_info">
        ...
        <form id='termsForm' method="post" action="">
          ...
          <div class="all_agree_box m0 is_open">
        	...
        	<c:forEach items="${terms}" var="term" varStatus="status">
                <li>
                  ...
                  <a href="javascript:;" ap-click-area="약관동의" ap-click-name="약관동의 - (<c:out value="${term.tncAgrMandYnTxt}" />) '${term.tncTtl}' 상세보기 버튼" ap-click-data="(<c:out value="${term.tncAgrMandYnTxt}" />) '<c:out value="${term.tncTtl}" />' 상세보기" class="btn_link" data-lnk="<c:out escapeXml="false" value="${term.tncTxtUrl}"/>" data-chcd="<c:out escapeXml="false" value="${chCd}"/>" data-lnkcd="<c:out escapeXml="false" value="${term.tcatCd}" />" data-lnkno="<c:out escapeXml="false" value="${term.tncvNo}" />"><span class="blind">자세히보기</span></a>
                </li>
          ...
          <div class="btn_submit ver2">
            ...
            <button type="button" class="btnA btn_blue" id='term-agree-ok' ap-click-area="약관동의" ap-click-name="약관동의 - 동의하고 서비스 이용 버튼" ap-click-data="동의하고 서비스 이용">동의하고 서비스 이용</button>
          </div>
