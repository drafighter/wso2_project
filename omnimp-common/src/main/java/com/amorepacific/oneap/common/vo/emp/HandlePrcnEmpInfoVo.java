...
@Data
public class HandlePrcnEmpInfoVo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1972686063018469742L;
	private String athtKey; // 인증Key
