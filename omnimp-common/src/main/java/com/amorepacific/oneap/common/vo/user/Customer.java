...
/**
 * <pre>
 * com.amorepacific.oneap.auth.api.vo 
 *    |_ CustBasicVo.java
 * </pre>
 *
 * @desc :
...
public class Customer implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3589292874851793452L;
	...
	// private String chCdNm; // 경로구분명 -> 2022.02.15 고객통합플랫폼 API 변경으로 삭제
	...
	// private String atclCd; // 휴대폰인증구분코드 -> 2022.02.15 고객통합플랫폼 API 변경으로 삭제
	// private String joinCnclYn; // 가입망취소여부 -> 2022.02.15 고객통합플랫폼 API 변경으로 삭제
